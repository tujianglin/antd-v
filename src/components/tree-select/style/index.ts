...
import type { AliasToken, CSSUtil, FullToken, GenerateStyle, GetDefaultToken } from '../../theme/internal';
...
// ============================== Export ==============================
export default function useTreeSelectStyle(prefixCls: Ref<string>, treePrefixCls: string, rootCls: Ref<string>) {
