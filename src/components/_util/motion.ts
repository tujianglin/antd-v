import type { CSSMotionProps, MotionEndEventHandler, MotionEventHandler } from '@/vc-component/motion';
import type { MotionEvent } from '@/vc-component/motion/interface';
