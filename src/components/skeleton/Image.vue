...
import SkeletonNode, { type SkeletonNodeProps } from './Node.vue';
...
const prefixCls = computed(() => getPrefixCls.value('skeleton', props.prefixCls));
</script>
<template>
  <SkeletonNode v-bind="props" :internal-class-name="`${prefixCls}-image`">
