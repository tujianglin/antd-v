...
export const getMultipleSelectorUnit = (
  token: Pick<
    SelectToken,
    'max' | 'calc' | 'multipleSelectItemHeight' | 'paddingXXS' | 'lineWidth' | 'INTERNAL_FIXED_ITEM_MARGIN'
  >,
) => {
...
const genSelectionStyle = (token: TokenWithCommonCls<AliasToken> & SelectItemToken, suffix?: string): CSSObject => {
