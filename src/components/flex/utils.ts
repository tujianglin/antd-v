...
export const flexWrapValues: CSSProperties['flexWrap'][] = ['wrap', 'nowrap', 'wrap-reverse'];

export const justifyContentValues: CSSProperties['justifyContent'][] = [
  'flex-start',
  'flex-end',
  'start',
  'end',
...
export const alignItemsValues: CSSProperties['alignItems'][] = [
  'center',
  'start',
  'end',
  'flex-start',
