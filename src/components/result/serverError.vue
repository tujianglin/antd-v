...
<template>
  <svg width="254" height="294">
    ...
    <g fill="none" fillRule="evenodd">
      ...
      />
      <path stroke="#DB836E" d="m99.2 73.6-.9 1.7-.3 4.3h-2.2" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path stroke="#5C2552" d="M100 73.3s1.7-.7 2.4.5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path
        stroke="#DB836E"
        ...
        strokeWidth="1.1"
      />
      <path stroke="#5C2552" d="M92.3 71.7s1.9 1.1 4.2 1" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path
        stroke="#DB836E"
      ...
      <path fill="#CBD1D1" d="M44.4 272s-2.2 7.8-4.7 13c-1.9 3.8-4.4 7.8 5.8 7.8 7 0 9.3-.5 7.7-7-1.6-6.3.3-13.8.3-13.8h-9z" />
      <path
        fill="#2B0849"
      ...
      <path
        ...
        strokeWidth="1.1"
      />
      <path stroke="#648BD8" d="M97 219.4s2.9-1.2 6.3-4" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
      <path
        stroke="#648BD8"
      ...
      />
      <path fill="#192064" d="M95.2 144.3v-3.2a.7.7 0 0 0-.6-.7h-6.1a.7.7 0 0 0-.6.7v3.2c0 .4.3.7.6.7h6c.4 0 .7-.3.7-.7" />
      <path
        stroke="#648BD8"
      ...
      <path
        ...
        strokeWidth=".8"
      />
      <path stroke="#E4EBF7" d="M109.3 112.5s3.4-3.6 7.6-4.6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path stroke="#E59788" d="M107.4 123s9.7-2.7 11.4-.9" strokeLinecap="round" strokeLinejoin="round" strokeWidth=".8" />
      <path
        stroke="#BFCDDD"
        ...
        strokeWidth="2"
      />
      <path fill="#A3B4C6" d="M190.2 211.8h-1.6a4 4 0 0 1-4-4v-32.1a4 4 0 0 1 4-4h1.6a4 4 0 0 1 4 4v32a4 4 0 0 1-4 4" />
      <path fill="#A3B4C6" d="M237.8 213a4.8 4.8 0 0 1-4.8 4.8h-86.6a4.8 4.8 0 0 1 0-9.6H233a4.8 4.8 0 0 1 4.8 4.8" />
      ...
      <path
        ...
        strokeWidth="1.1"
      />
      <path fill="#5BA02E" d="M162.9 267.9a9.4 9.4 0 0 1-9.4-9.4v-14.8a9.4 9.4 0 0 1 18.8 0v14.8a9.4 9.4 0 0 1-9.4 9.4" />
      <path fill="#92C110" d="M171.2 267.8a9.4 9.4 0 0 1-9.4-9.4V255a9.4 9.4 0 0 1 18.8 0v3.4a9.4 9.4 0 0 1-9.4 9.4" />
      <path
        fill="#F2D7AD"
