...
<template>
  <svg width="251" height="294">
    ...
    <g fill="none" fillRule="evenodd">
      ...
      />
      <path fill="#5BA02E" d="M168.2 248.8a6.6 6.6 0 0 1-6.6-6.6v-66a6.6 6.6 0 0 1 13.2 0v66a6.6 6.6 0 0 1-6.6 6.6" />
      <path fill="#92C110" d="M176.1 248.2a6.6 6.6 0 0 1-6.6-6.6v-33a6.6 6.6 0 1 1 13.3 0v33a6.6 6.6 0 0 1-6.7 6.6" />
      <path
        fill="#F2D7AD"
      ...
      />
      <path stroke="#E4EBF7" d="M78.2 94.7s.9 7.4-5 13" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path
        stroke="#E4EBF7"
      ...
      />
      <path fill="#FFB594" d="m105.3 91.3-.3-11H89l-.5 10.5c0 .4.2.8.6 1 2 1.3 9.3 5 15.8.4.2-.2.4-.5.4-.9" />
      <path
        fill="#5C2552"
      ...
      />
      <path stroke="#DB836E" d="m100.8 77.1 1.7-1-1-4.3.7-1.4" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path
        fill="#552950"
      ...
      />
      <path stroke="#DB836E" d="M91.1 86.8s5.3 5 12.7 2.3" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      ...
      <path
        ...
        strokeWidth="1.1"
      />
      <path stroke="#DB836E" d="M64 84.8s-6 10-13.5 10" strokeLinecap="round" strokeLinejoin="round" strokeWidth=".8" />
      <path
        fill="#FFC6A0"
      ...
      />
      <path stroke="#DB836E" d="M130.5 85.5s4.6 5.7 11.7 6.2" strokeLinecap="round" strokeLinejoin="round" strokeWidth=".8" />
      <path stroke="#E4EBF7" d="M121.7 105.7s-.4 8.6-1.3 13.6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path stroke="#648BD8" d="M115.8 161.5s-3.6-1.5-2.7-7.1" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path
        fill="#CBD1D1"
      ...
      />
      <path fill="#A4AABA" d="M58.5 274.4s0 1.6-.3 3-1 3.1-1.1 4.2c0 1.1 4.5 1.5 5.2 0 .6-1.6 1.3-6.5 1.9-7.3.6-.8-5-2.1-5.7.1" />
      <path
        fill="#7BB2F9"
      ...
      <path
        ...
        strokeWidth="1.1"
      />
      <path stroke="#648BD8" d="M108.5 221s2.7-1.2 6-4" strokeLinecap="round" strokeLinejoin="round" />
      <path
        stroke="#648BD8"
