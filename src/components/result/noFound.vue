...
<template>
  <svg width="252" height="294">
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <path fill="#FFF" d="M106.3 151.2v-5a.8.8 0 0 0-.8-.8h-7.8a.8.8 0 0 0-.8.8v5a.8.8 0 0 0 .8.8h7.8a.8.8 0 0 0 .8-.8" />
      <path
        fill="#192064"
      ...
      />
      <path stroke="#DB836E" d="m110.1 74.8-.9 1.7-.3 4.3h-2.2" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path stroke="#5C2552" d="M110.8 74.5s1.8-.7 2.6.5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
      <path
        stroke="#DB836E"
      ...
      <path
        ...
        strokeWidth="1.1"
      />
      <path fill="#5BA02E" d="M168.6 248.3a6.6 6.6 0 0 1-6.7-6.6v-66.5a6.6 6.6 0 1 1 13.3 0v66.5a6.6 6.6 0 0 1-6.6 6.6" />
      <path fill="#92C110" d="M176.5 247.7a6.6 6.6 0 0 1-6.6-6.7v-33.2a6.6 6.6 0 1 1 13.3 0V241a6.6 6.6 0 0 1-6.7 6.7" />
      <path
        fill="#F2D7AD"
      ...
      />
      <path stroke="#E4EBF7" d="M89 89.5s7.8 5.4 16.6 2.8" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" />
    </g>
  </svg>
</template>
